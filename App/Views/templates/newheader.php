...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="<?= APP['DOC_ROOT'] ?>assets/css/sb-admin-2.min.css">
                ...
                <div class="content-header content-header-fullrow">
                    <div class="content-header-section align-parent">
                        ...
                        <div class="content-header-item">
                            <a class="img-link mr-5" href="/system/profile">
                                <img class="img-avatar img-avatar32" src="<?= APP['DOC_ROOT'] ?>public/img/avatars/avatar15.jpg" alt="">
                            </a>
                            <a id="side_overlay_name" class="text-capitalize align-middle link-effect text-capitalize text-primary-dark font-w600" href="/system/profile">
                                <?=
                                     Auth::user()->lastname . ' , ' .
                                     Auth::user()->firstname . ' ' .
                    ...
                    <div class="block pull-r-l">
                        ...
                        <div class="block-content">
                            <ul class="nav-users push">
                                ...
                                <li>
                                    <i class="fa fa-fw fa-trash"></i> <?= $info['Name'] ?>
                                    <div class="d-inline-flex">
                                        <a class="font-w400" href="/system/admin/restore?a_id=<?= urlencode($info['id'])?>">Restore</a>
                                        <!-- urlencode($info['id']) -->
                                        <!-- urlencode($info['entrace_rating_id']) -->
                                        <!-- urlencode($info['examiner_info_id']) -->
                                        <a href="/system/admin/permanent_delete?a_id=" class="font-w400 ">P - Delete</a>
                                    </div>
                                </li>
                                <?php endforeach ?>
                            </ul>
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            <a class="img-link " href="/system/profile">
                                <img id="sidebar_img" class="img-fluid img-avatar rounded-circle" src="<?= APP['DOC_ROOT'] . 'assets/img/uploads/' . Auth::user()->profile; ?>" alt="">
                                
                            </a>
                            <ul class="list-inline mt-10">
                                <li class="list-inline-item">
                                    <a id="sidebar_name" class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="/system/profile">
                                        <?= 
                                        Auth::user()->lastname . ' , '. 
                                        Auth::user()->firstname . ' ' . 
                                        Auth::user()->middlename ?>.</a>
                                </li>
                                <li class="list-inline-item">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <a href="/system/profile/"><i class="si si-user"></i><span class="sidebar-mini-hide">Profile</span></a>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/system/profile/edit">Personal Information</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="content-header-section">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right min-width-150" aria-labelledby="page-header-user-dropdown">
                            ...
                            <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/system/admin/logout">
