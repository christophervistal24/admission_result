                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-material">
                                ...
                                <?php endif ?>
                                <input required id="examiner_lastname" type="text" value="<?= $examiner_results->lastname ?>" class="text-capitalize form-control" name="lastname" placeholder="Enter a lastname..">
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-material">
                                <input required type="text" id="examiner_firstname" value="<?= $examiner_results->firstname ?>" class="text-capitalize form-control" name="firstname" placeholder="Enter a firstname..">
                            </div>
                            <div class="text-center">
                        ...
                        <div class="col-lg-4">
                            <div class="form-material">
                                <input required type="text" id="examiner_middlename" value="<?= $examiner_results->middlename ?>" class="text-uppercase font-weight-bold text-center form-control" id="val-username2" name="middlename" placeholder="M">
                            </div>
                            <div class="text-center">
                                <label for="">M.I</label>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-material">
                                <select  name="sex" id="examiner_sex" class="form-control">
                        ...
                        <div class="col-lg-2 ml-lg-auto">
                            <div class="form-material">
                                <input id="examiner_age" value="<?= $examiner_results->age ?>" required type="number" name="age" class="form-control" id="">
                            </div>
                            <div class="text-center">
                                <label for="">Age</label>
                            </div>
                        ...
                        <div class="col-lg-4 ml-lg-auto">
                            <div class="form-material">
                                <input id="examiner_birthdate" value="<?= $examiner_results->birthdate ?>" required type="date" name="birthdate" class="form-control" id="">
                            </div>
                            <div class="text-center">
                        ...
                        <div class="col-lg-4">
                            <div class="form-material">
                                <select required type="text" id="examiner_first_course" class="form-control" name="first_preferred_course" id="" placeholder="1st">
                        ...
                        <div class="col-lg-4">
                            <div class="form-material">
                                <select required type="text" id="examiner_second_course" class="form-control" name="second_preferred_course" id="" placeholder="2nd">
                                    <?php foreach ($course as $keys => $courses): ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered table-vcenter">
                                <thead>
                                    <tr>
                                        <th>TOTAL</th>
                                        <th class="text-center d-none d-sm-table-cell" rowspan="2">Raw Score <hr><input type="number" readonly="" id="over_all_total" value="<?= $examiner_results->verbal_total + $examiner_results->non_verbal_total  ?>" name="over_all_total" class="form-control border-0 text-center" id="over_all_total" placeholder="OVER ALL TOTAL"></th>
                                ...
                                <tbody>
                                    <tr class="text-center">
                                        ...
                                        <td><input  id="total_of_verbal" value="<?= $examiner_results->verbal_total  ?>" name="verbal_total" placeholder="TOTAL OF VERBAL" type="number"  readonly class="total text-center form-control border-0"></td>
                                    ...
                                    <tr>
                                        <th class="text-center" scope="row">
                                            <input type="number" value="<?= $examiner_results->verbal_comprehension  ?>" required name="verbal_comprehension" id="verbal-comprehension"  class="verbal-score text-center form-control border-0" placeholder="Enter score here..">
                                        </th>
                                        <td class="text-center d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <th class="text-center" scope="row">
                                            <input type="number" required id="verbal-reasoning" name="verbal_reasoning" value="<?= $examiner_results->verbal_reasoning  ?>" class="verbal-score text-center form-control border-0" placeholder="Enter score here..">
                                        </th>
                                        <td class="text-center d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input value="<?= $examiner_results->non_verbal_total  ?>" name="non_verbal_total" id="total_of_non_verbal" placeholder="NON VERBAL TOTAL" readonly type="number"  class="total text-center form-control border-0"></td>
                                        <td class="text-center d-none d-sm-table-cell">
                            ...
                            <div class="col-lg-4 float-right ">
                                <div class="text-left form-material">
                                    ...
                                    <select type="text" required name="guidance_counselor" id="guidance_counselor_name"  class=" text-center form-control">
                                        <?php global $position; ?>
