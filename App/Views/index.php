    ...
    <div class="mbr-section__container">
        <div>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height active" style="background-image: url(<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067991-1920-1920x1440-38.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
                            ...
                            <div class="row"><div class="col-sm-8 col-sm-offset-2">
                                ...
                                <div class="mbr-buttons btn-inverse mbr-buttons--center"><a class="mbr-buttons__btn btn btn-lg btn-warning" href="https://mobirise.com/bootstrap-template/mobirise-free-template.zip">DOWNLOAD FREE TEMPLATE</a> </div>
                            </div></div>
                        </div>
                    </div>
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067982-1920-1920x1439-71.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
                ...
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067975-1920-1920x1439-26.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-after-navbar">
                        <div class=" container">
...
<section class="content-2 col-4" id="features1-21" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/google-slides-350x350-16.png"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/reminders-350x350-18.png"></div>
                    <div class="caption">
                        <div>
                            <h3>CONTACT FORMS</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/photos-350x350-95.png"></div>
                    <div class="caption">
                        <div>
                            <h3>IMAGE GALLERY</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/kindle-350x350-47.png"></div>
                    <div class="caption">
                        <div>
                            <h3>MOBILE MENU</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header1-22" style="background-image: url(<?= APP['DOC_ROOT'] ?>assets/images/iphone-926663-1920-1920x1280-94.jpg);">
...
<section class="content-2 col-4" id="features1-23" style="background-color: rgb(28, 73, 110);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/maps-350x350-26.png"></div>
                    <div class="caption">
                        <div>
                            <h3>GOOGLE MAPS</h3>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/facebook-350x350-71.png"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/bytafont-350x350-38.png"></div>
                    <div class="caption">
                        <div>
                            <h3>GOOGLE FONTS</h3>
                            <p>Duis sodales arcu eget gravida mollis. Sed condimentum nibh at dapibus semper. Etiam mattis leo at commodo eleifend. Integer mauris est, luctus vitae lobortis sed, tristique in eros. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/youtube-350x350-69.png"></div>
                    <div class="caption">
                        <div>
...
<section class="mbr-section mbr-section--relative mbr-parallax-background" id="msg-box5-25" style="background-image: url(<?= APP['DOC_ROOT']?>assets/images/iphone-6-458150-1920-1920x1285-73.jpg);">
...
<section class="content-2 col-3" id="features1-26" style="background-color: rgb(239, 239, 239);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/phone-350x350-12.png"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/anemone-350x350-67.png"></div>
                    <div class="caption">
                        <div>
                            <h3>EASY-TO-USE</h3>
                            <p>Sed vel vulputate lacus. Nulla et fringilla turpis. Etiam non urna magna. Fusce rutrum nec eros id dapibus. In tincidunt mi eget molestie condimentum.</p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/clear-350x350-99.png"></div>
                    <div class="caption">
                        <div>
                            <h3>FREE</h3>
                            <p>Sed vel vulputate lacus. Nulla et fringilla turpis. Etiam non urna magna. Fusce rutrum nec eros id dapibus. In tincidunt mi eget molestie condimentum.</p>
...
<section class="mbr-gallery mbr-section mbr-section--no-padding" id="gallery1-28" style="background-color: rgb(239, 239, 239);">
    <!-- Gallery -->
    ...
    <!-- Lightbox -->
    <div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery1-28">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <ol class="carousel-indicators">
                        <li data-app-prevent-settings="" data-target="#lb-gallery1-28" data-slide-to="0"></li><li data-app-prevent-settings="" data-target="#lb-gallery1-28" data-slide-to="1"></li><li data-app-prevent-settings="" data-target="#lb-gallery1-28" data-slide-to="2"></li><li data-app-prevent-settings="" data-target="#lb-gallery1-28" class=" active" data-slide-to="3"></li>
                    </ol>
                    <div class="carousel-inner">
                        <div class="item">
                            <img alt="" src="<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067975-1920-1920x1439-11.jpg">
                        </div><div class="item">
                            <img alt="" src="<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067982-1920-1920x1439-68.jpg">
                        </div><div class="item">
                            <img alt="" src="<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067983-1920-1920x1440-44.jpg">
                        </div><div class="item active">
                            <img alt="" src="<?= APP['DOC_ROOT'] ?>assets/images/iphone-1067991-1920-1920x1440-57.jpg">
                        </div>
                    </div>
                    <a class="left carousel-control" role="button" data-slide="prev" href="#lb-gallery1-28">
                        <span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="right carousel-control" role="button" data-slide="next" href="#lb-gallery1-28">
                        <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
                        <span class="sr-only">Next</span>
                    </a>
...
<section class="msgbox-1" id="msg-box2-29" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4"><a class="btn btn-lg btn-default" href="https://mobirise.com/bootstrap-template/">GET IT NOW</a></div>
        </div>
    </div>
</section>
...
<section class="content-2 col-4" id="features1-31" style="background-color: rgb(255, 255, 255);">

    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/workflow-350x350-59.png"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/chrome-remote-desktop-350x350-23.png"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/com-350x350-41.png"></div>
                    <div class="caption">
                        <div>
                            <h3>WEB FONTS</h3>
                            <p>Etiam lacinia volutpat magna, sed lobortis risus egestas in. Nunc fringilla urna ac libero venenatis molestie. Curabitur molestie mi quis mauris convallis aliquet. Cras pretium sapien mi, sed sagittis est ultrices at.</p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="<?= APP['DOC_ROOT'] ?>assets/images/calculator-350x350-78.png"></div>
                    <div class="caption">
                        <div>
                            <h3>PRICE TABLES</h3>
                            <p>Etiam lacinia volutpat magna, sed lobortis risus egestas in. Nunc fringilla urna ac libero venenatis molestie. Curabitur molestie mi quis mauris convallis aliquet. Cras pretium sapien mi, sed sagittis est ultrices at.</p>
        ...
        <div class="row">
            <div>
                <div class="plan green">
                    ...
                    <p><a href="https://mobirise.com/bootstrap-template/" class="btn btn-success">DEMO LINK</a></p>
                </div>
            </div>
            <div>
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="social-buttons1-33" style="background-color: rgb(247, 218, 100);">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="testimonials1-34" style="background-color: rgb(255, 255, 255);">
    <div>
